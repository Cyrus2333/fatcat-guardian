...
- 演示视频：[肥猫守护演示视频-opencut.mp4](./preview/%E8%82%A5%E7%8C%AB%E5%AE%88%E6%8A%A4%E6%BC%94%E7%A4%BA%E8%A7%86%E9%A2%91-opencut.mp4)
...
仓库中新增了一套独立静态官网，目录在 `site/`，用于作为项目官网部署到 GitHub Pages。

当前特性：

- 不依赖额外前端框架
- 不影响 Electron 桌面应用构建链路
- 使用 `.github/workflows/deploy-pages.yml` 自动发布
...
1. 推送到 `main` 分支
2. 在 GitHub 仓库 `Settings > Pages` 中确认 Source 使用 GitHub Actions
